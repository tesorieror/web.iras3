...
summaryTableChart
		.directive(
				...
				function() {
					return {
						restrict : 'E',
						templateUrl : '/modules/summary-table-chart/summary-table-chart-directive.html',
						scope : {
							categories : '=',
							indicators : '=',
							selectedTags : '=',
						...
						controller : 'SummaryTableChartCtrl'
					};
				});

summaryTableChart
		.controller(
				'SummaryTableChartCtrl',
				function($scope, $log, $location, $filter, $rootScope, c) {
					$log.log('Summary Chart controller loaded!')
